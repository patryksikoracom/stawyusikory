  ...
  return {
    ...
    bookings: data.bookings.map((booking, index) => {
      ...
      return {
        ...
        guestPaidTotal: booking.guestPaidTotal ?? imported?.guestPaidTotal,
        guestServiceFee: booking.guestServiceFee ?? imported?.guestServiceFee,
        priceAdjustment: booking.priceAdjustment ?? imported?.priceAdjustment,
        ...
        paymentProcessingFee: imported?.paymentProcessingFee,
        totalOtaFees: imported?.totalOtaFees,
